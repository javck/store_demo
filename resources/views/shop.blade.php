		...
		<header id="header" class="full-header no-sticky clearfix">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo"><img src="/ecommerce/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo"><img src="/ecommerce/images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="style-ecommerce">
						...
						<ul>
							...
							<!-- Mega Menu
							============================================= -->
							<li class="mega-menu"><a href="#"><div>Men</div></a>
								<div class="mega-menu-content style-2 clearfix" style="background-image: url('images/shop/shop-menu.jpg'); background-repeat: no-repeat; background-position: right bottom;">
											...
											<div class="widget clearfix">
												...
												<div class="iportfolio clearfix">
													<div class="portfolio-image clearfix">
														<a href="#"><img src="/ecommerce/images/items/1-1.jpg" alt="Grey Bag"></a>
												...
												<div class="widget-last-view">
													<div class="spost clearfix">
														<div class="entry-image">
															<a href="#"><img src="/ecommerce/images/items/2-1.jpg" alt="Image"></a>
														</div>
														<div class="entry-c">
													...
													<div class="spost clearfix">
														<div class="entry-image">
															<a href="#"><img src="/ecommerce/images/items/3-1.jpg" alt="Image"></a>
														</div>
														<div class="entry-c">
															<div class="entry-title">
													...
													<div class="spost clearfix">
														<div class="entry-image">
															<a href="#"><img src="/ecommerce/images/items/4-1.jpg" alt="Image"></a>
														</div>
														<div class="entry-c">
															<div class="entry-title">
									...
									<ul class="mega-menu-column col-lg-2">
										<li class="mega-menu-title"><a href="#"><div>Categories</div></a>
											<ul>
												<li><a href="#"><div><i class="icon-t-shirt"></i>Travel Bags</div></a></li>
												<li><a href="#"><div><i class="icon-laptop2"></i>Backpacks</div></a></li>
												<li><a href="#"><div><i class="icon-clock2"></i>Leather Bag</div></a></li>
												<li><a href="#"><div><i class="icon-plane"></i>Travel Bag</div></a></li>
												<li><a href="#"><div><i class="icon-barbell"></i>Trolley</div></a></li>
												<li><a href="#"><div><i class="icon-heart3"></i>Workout Bag</div></a></li>
												<li><a href="#"><div><i class="icon-film"></i>Hand Bag</div></a></li>
											</ul>
										</li>
									</ul>
									<ul class="mega-menu-column col-lg-2 noleftborder">
										<li class="mega-menu-title"><a href="#"><div>Popular Brands</div></a>
											<ul>
												<li><a href="#"><div>United Colors</div></a></li>
												<li><a href="#"><div>Burton London</div></a></li>
								...
								<div class="top-cart-items">
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#"><img src="/ecommerce/images/featured/1.jpg" alt="Blue Shoulder Bag" /></a>
										</div>
									...
									<div class="top-cart-item clearfix">
										<div class="top-cart-item-image">
											<a href="#" class="t400"><img src="/ecommerce/images/featured/6.jpg" alt="Leather Bag" /></a>
										</div>
										<div class="top-cart-item-desc">
		...
		<section id="slider" class="slider-element swiper_wrapper full-screen clearfix" data-autoplay="9000" data-speed="800" data-loop="true" data-grab="false">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background: #FFF url('/ecommerce/images/slider/1.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
									<h2 class="bottommargin t700" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">用Laravel建立<br>電子商務網站</h2>
					...
					<div class="swiper-slide" style="background: #FFF url('/ecommerce/images/slider/2.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
									<h2 class="bottommargin t700" style="max-width: 600px; font-size: 80px; font-family: 'Montserrat'; line-height: 1.2;">你只需要<br>Laravel5.8 從入門到實務</h2>
					...
					<div class="swiper-slide" style="background: #FFF url('images/ecommerce/images/slider/3.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
					...
					<div class="swiper-slide" style="background: #FFF url('images/ecommerce/images/slider/4.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
					...
					<div class="swiper-slide" style="background: #FFF url('images/ecommerce/images/slider/5.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
					...
					<div class="swiper-slide" style="background: #FFF url('images/ecommerce/images/slider/6.jpg') no-repeat center right; background-size: auto 100%;">
						<div class="container clearfix">
							<div class="slider-caption" style="margin-top: -30px;">
								<div class="emphasis-title nobottommargin">
			...
			<div class="content-wrap nopadding">
						...
						<div class="row grid-item clearfix">
							...
							<div class="col-md-2">
								<div class="grid-info clearfix">
									...
									<i class="icon-map-marker2"></i> <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2233.681463596743!2d-3.19397378404521!3d55.954892680607855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4887c78e1e83edab%3A0x627ac6bc4414f18b!2sGucci+-+Edinburgh+Harvey+Nichols+Women&#39;s!5e0!3m2!1sen!2sus!4v1489749205966" data-lightbox="iframe"  class="more-link clearfix">Find Store</a>
								</div>
							</div>
						</div>
				...
				<div class="container clearfix">
					...
					<div class="row ecommerce-categories clearfix" style="padding: 20px 0 0;">
						<div class="col-lg-7">
							<a href="#" style="background: url('images/ecommerce/images/types/1.jpg') no-repeat center center; background-size: cover;">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url('images/ecommerce/images/types/3.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('images/ecommerce/images/types/5.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('images/ecommerce/images/types/6.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('images/ecommerce/images/types/8.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url('images/ecommerce/images/types/7.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-7">
							<a href="#" style="background: url('images/ecommerce/images/types/9.jpg') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
										...
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/1-1.jpg" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/1-2.jpg" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/1-3.jpg" alt="Grey Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
								...
								<div class="iportfolio clearfix">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/4-1.jpg" alt="Grey Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/4-2.jpg" alt="Grey Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
								...
								<div class="iportfolio clearfix">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/2-1.jpg" alt="Office Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/2-2.jpg" alt="Office Bag"></a></div>
												</div>
											</div>
										</div>
										<div class="product-cart"><a href="#"><i class="icon-shopping-cart"></i></a></div>
								...
								<div class="iportfolio clearfix">
									<div class="portfolio-image clearfix">
										<div class="fslider" data-pagi="false" data-animation="fade" data-slideshow="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/3-1.jpg" alt="Men Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/3-2.jpg" alt="Men Bag"></a></div>
													<div class="slide"><a href="#"><img src="/ecommerce/images/items/3-3.jpg" alt="Men Bag"></a></div>
												</div>
											</div>
										</div>
							...
							<div class="col-lg-5 offset-lg-1">
								<div class="featured-item topmargin">
									<div class="item-title">
										<div class="before-heading t600 ls5"><a href="#" style="color: #aab7bd !important;">Leather Bags <i class="icon-angle-right"></i></a></div>
				...
				<div class="row align-items-stretch bottommargin clearfix">
					<div class="col-md-6" style="background: url('/ecommerce/images/sections/1.jpg') center 45% no-repeat; background-size: cover; padding: 0 0 500px;">
					...
					<div class="col-md-6" style="background: url('/ecommerce/images/sections/3.jpg') center center no-repeat; background-size: cover; padding: 0 0 500px;">
						<div class="section-content topmargin-sm">
